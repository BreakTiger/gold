  ...
  getData: function () {
    ...
    http.sendRequest('huishou.shopma', 'post', data).then(function (res) {
      ...
      if (res.error == 0) {
        ...
        ctx.drawImage('../../img/poster.png', 0, 0, 375, 576.5);  //绘制背景图
              ...
              success: function (res) {
                ...
                wx.downloadFile({
                  ...
                  success: function (res) {
                    ...
                    ctx.fillText(detail.shopname, 35, 280, 296)

                    // 电话
                    ctx.setFontSize(16) //文字大小
                    ctx.setFillStyle('#000000') //文字颜色
                    ctx.fillText('电话：' + detail.mobile, 35, 320, 296)

                    // 地址
                    ctx.setFontSize(16) //文字大小
                    ctx.setFillStyle('#000000') //文字颜色
                    ctx.fillText('地址：' + detail.province + detail.city + detail.area, 35, 350, 296)
